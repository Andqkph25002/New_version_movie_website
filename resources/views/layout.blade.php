...
<head>
    ...
    <style>
        #header .site-title {
            background: url(https://img.pikbest.com/png-images/creative-a-letter-logo-design_1599370.png!w700wp) no-repeat top left;
...
<body class="home blog halimthemes halimmovies" data-masonry="">
        ...
        <div class="container">
            <div class="row" id="headwrap">
                <div class="col-md-3 col-sm-6 slogan">
                    <p class="site-title">
                        <img src="https://img.pikbest.com/png-images/creative-a-letter-logo-design_1599370.png!w700wp"
                            alt="">
                    </p>
                </div>
                <div class="col-md-5 col-sm-6 halim-search-form hidden-xs">
                    <div class="header-nav">
                        <div class="col-xs-12">
                            ...
                            <ul class="list-group" id="result" style=""></ul>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 hidden-xs">
                    @if (!Auth::check())
                        <div id="get-bookmark" class="box-shadow"><a href="{{ route('auth.google') }}">Đăng nhập
                                google</a>
                        </div>
                        <div id="get-bookmark" class="box-shadow"><a href="">Đăng nhập facebook</a></div>
                    @else
                        <a href="" class="text-white" style="margin-right: 10px">{{ Auth::user()->name }}</a>
                        <div id="get-bookmark" class="box-shadow"><a href="">Đăng xuất</a></div>
                    @endif
                    ...
                    <div class="menu-menu_1-container">
                        <ul id="menu-menu_1" class="nav navbar-nav navbar-left">
                            <li class="current-menu-item active"><a title="Trang Chủ"
                                    href="{{ route('home.page') }}">Trang Chủ</a></li>
                ...
                <div class="widget about col-xs-12 col-sm-4 col-md-4">
                    <div class="footer-logo">
                        <img class="img-responsive"
                            src="https://img.pikbest.com/png-images/creative-a-letter-logo-design_1599370.png!w700wp"
                            alt="Phim hay 2021- Xem phim hay nhất" />
                    </div>
                    Liên hệ người sản xuất: <a href="/cdn-cgi/l/email-protection" class="__cf_email__"
                        data-cfemail="e5958d8c888d849ccb868aa58288848c89cb868a88">quangan010903@gmail.com</a>
                </div>
            </div>
        </div>
    </footer>
                    ...
                    $.getJSON('/json_file/movie.json', function(data) {
                        $.each(data, function(key, value) {
                            if (value.title.search(expression) != -1 || value.description
                                .search(expression) != -1) {
                                $("#result").append(
                                    '<li style="cursor:pointer; display: flex; max-height: 200px;" class="list-group-item link-class"><img src="/storage/' +
                                    value.image +
                                    '" width="100" class="" /><div style="flex-direction: column; margin-left: 10px;"><h4 width="100%">' +
                                    value.title +
    ...
    <script>
        $(document).ready(function() {
            $.ajax({
                url: "{{ url('/filter-topview-movie-default') }}",
                method: "GET",
            ...
            $.ajax({
                ...
                success: function(data) {
                    if (data == 'done') {
                        ...
                        alert("Bạn đã đánh giá bộ này rồi , xin cảm ơn ");
                    } else {
                        alert("Lỗi đánh giá");
                    }
                }
