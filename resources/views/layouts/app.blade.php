    ...
    <script>
        $('.selectSeason').change(function() {
            ...
            $.ajax({
                ...
                success: function() {
                    alert("Thay đổi season phim theo năm " + season + " thành công !");
                }
            })
        })
    </script>
    ...
    <script>
        $(".select-topview").change(function() {
            ...
            $.ajax({
                ...
                success: function() {
                    alert("Thay đổi trạng thái " + text + " thành công !");
                }
            })
        })
    </script>
    ...
    <script>
        $(".category_choose").change(function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    alert("Thay đổi danh mục phim thành công !");
                }
            })
        })
    </script>
    ...
    <script>
        $(".resolution_choose").change(function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    alert("Thay đổi chất lượng phim thành công");
                }
            })
        })
    </script>
    <script>
        $(".phude_choose").change(function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    alert("Thay đổi phụ đề phim thành công");
                }
            })
        })
    </script>
    <script>
        $(".phimhot_choose").change(function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    alert("Thay đổi trạng thái phim hot phim thành công");
                }
            })
        })
    </script>
    <script>
        $(".thuocphim_choose").change(function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    alert("Thay đổi thuộc tính phim thành công");
                }
            })
        })
    </script>
